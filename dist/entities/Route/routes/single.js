...
function single(handler) {
    var _this = this;
    var loaders = new Map();
    return handle_1.default(function (req, res, ctx) { return __awaiter(_this, void 0, void 0, function () {
        var loader;
        return __generator(this, function (_a) {
            if (loaders.has(req.path)) {
                return [2 /*return*/, loaders.get(req.path)];
            }
            loader = handler(req, res, ctx)
