...
exports.fetchEstateBalance = exports.ChainId = void 0;
...
function fetchEstateBalance(address, chainId) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var skip, estates, lands, hasNext, first, response, body, nfts, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    estates += nfts.length;
                    lands += nfts.reduce(function (total, nft) { return total + nft.searchEstateSize; }, 0);
                    skip += first;
                    hasNext = nfts.length === first;
                    return [3 /*break*/, 2];
                case 5: return [2 /*return*/, [estates, lands]];
                case 6:
                    err_1 = _b.sent();
                    console.error(err_1);
...
exports.fetchEstateBalance = fetchEstateBalance;
