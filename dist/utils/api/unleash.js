...
exports.DEFAULT_FEATURE_FLAG = {
    flags: {},
    variants: {},
};
function unleash(endpoint, options) {
    if (options === void 0) { options = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var headers, req, body, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!endpoint) {
                        return [2 /*return*/, exports.DEFAULT_FEATURE_FLAG];
                    }
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    ...
                    if (options.address && isEthereumAddress_1.default(options.address)) {
